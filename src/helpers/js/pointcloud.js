...
$(document).ready(function() {
    $('.point-cloud').click(function() {
        ...
        setTimeout(function() {
            ...
            //     boundaryExtraction(files[i], points, i);
            // }
            boundaryExtraction(files[0], points, 0);
            setTimeout(function() { boundaryExtraction(files[1], points, 1); }, 10);
            setTimeout(function() { boundaryExtraction(files[2], points, 2); }, 10);
            setTimeout(function() { boundaryExtraction(files[3], points, 3); }, 10);
            setTimeout(function() { boundaryExtraction(files[4], points, 4); }, 10);
            setTimeout(function() { boundaryExtraction(files[5], points, 5); }, 10);
            setTimeout(function() { boundaryExtraction(files[6], points, 6); }, 10);
            setTimeout(function() { boundaryExtraction(files[7], points, 7); }, 10);
            console.log(points);
        }, 10);
    ...
    function boundaryExtraction(file, point, index) {
